...
ALTER TABLE "vehicles" ADD COLUMN IF NOT EXISTS "fuel_type" text DEFAULT 'gas' NOT NULL;
ALTER TABLE "vehicles" ADD COLUMN IF NOT EXISTS "is_three_row_suv" boolean DEFAULT false NOT NULL;
ALTER TABLE "vehicles" ADD COLUMN IF NOT EXISTS "marketing_status" text DEFAULT 'not_marketed' NOT NULL;
DO $$ BEGIN
